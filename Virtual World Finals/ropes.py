...
def greedy(score_matrix):
    ...
    #   - they will not choose by a counter-greedy strategy (they choose as far east as possible), since we can never win by this greedy strategy if they can do that
    result = None
