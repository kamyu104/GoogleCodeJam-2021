...
|D| [Binary Search Game](https://codingcompetitions.withgoogle.com/codejam/round/0000000000436142/0000000000813e1b)| [PyPy](./Round%203/binary_search_game.py) | _O(N * 2^(2^(L-1)) * 2^L)_ | _O(N + 2^L)_ | Hard | | DP, Lagrange Interpolation |
