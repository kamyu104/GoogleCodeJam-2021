...
|E| [Infinitree](https://codingcompetitions.withgoogle.com/codejam/round/0000000000436329/000000000084fc01)| [PyPy](./Virtual%20World%20Finals/infinitree.py) | _O(N^3.5 * logN + N^3 * logB)_ | _O(N^2.5 * logN + N^2 * logB)_ | Very Hard | ❤️ | Binary Search, Tarjan's Algorithm, Matrix Exponentiation, Prefix Sum
